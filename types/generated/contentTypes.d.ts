...
export interface ApiAnswerAnswer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    month: Schema.Attribute.Enumeration<['February', 'October', 'July']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEssayEssay extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::essay.essay'> &
      Schema.Attribute.Private;
    month: Schema.Attribute.Enumeration<['February', 'July', 'October']>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', true>;
    slug: Schema.Attribute.UID<'title'>;
...
export interface ApiSubjectSubject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userSubmissions: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserEssaySubmissionUserEssaySubmission
  extends Struct.CollectionTypeSchema {
